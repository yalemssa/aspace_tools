...
'''This will be an interface for setting main program parameters and running functions


Want to do a command-line interface with the following arguments:
    csvfile OR csvdictfile
    dirpath (optional, or set via the config file?)
