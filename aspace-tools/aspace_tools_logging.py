...
'''
This file sets up logging for the aspace-tools package. All of the other files
import this file and then call the getLogger method to get their own custom loggers

To-DO: create logging decorator? Not sure how to implement
    1.) DEBUG message at start that says that a particular function is running
    2.) A try/except block over the whole function?

    With this method there's no reason I can't add other logging messages in
    functions as needed; this just sets a default to note when functions start
    and end and when any exceptions happen
