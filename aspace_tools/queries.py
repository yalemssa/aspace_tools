...
Note:
    ...
    ADD SUBFOLDERS IN SCRIPTS/SQL DIRECTORY AND THEN USE IN ORGANIZING APP DROPDOWN INSTEAD OF DOCSTRING
    Organize these functions in some way...

    How exactly does the custom reports thing work?
